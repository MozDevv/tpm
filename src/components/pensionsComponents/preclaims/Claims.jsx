...
import ClaimsApproval from "@/app/pensions/claims-approval/page";
...
export const mapRowData = (items) =>
  items
    .filter((item) => item.no)
    .map((item) => ({
      no_series: item?.prospectivePensioner?.no,
      ...
      mda_id: item?.prospectivePensioner?.mda_id,
      // mda_id: item?.prospectivePensioner?.mda?.pensionCap?.code,
      ...
      prospectivePensionerDocuments_length:
        item?.prospectivePensioner?.prospectivePensionerDocuments?.length,
      ...
      county: item?.prospectivePensioner?.constituency?.county?.county_name,
      ...
      branch_name: item?.prospectivePensioner?.bankDetails[0]?.bankBranch?.name,
      account_number:
        item?.prospectivePensioner?.bankDetails[0]?.account_number,
      account_name: item?.prospectivePensioner?.bankDetails[0]?.account_name,
      bankType:
      ...
      military_id: item?.prospectivePensioner?.military_id,
      monthly_salary_in_ksh: item?.prospectivePensioner?.monthly_salary_in_ksh,
      service_increment: item?.prospectivePensioner?.service_increment,
      monthly_additional_pay:
        item?.prospectivePensioner?.monthly_additional_pay,
      is_wcps: item?.prospectivePensioner?.is_wcps,
      is_parliamentary: item?.prospectivePensioner?.is_parliamentary,
      age_on_discharge: item?.prospectivePensioner?.age_on_discharge,
