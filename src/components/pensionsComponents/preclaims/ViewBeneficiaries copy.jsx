...
function EditBeneficiaryDialog({ open, onClose, beneficiary }) {
  ...
  const fields = [
    // Existing fields (Beneficiary and Guardian)
    ...
    { label: "Birth Certificate Number", name: "birth_cert_no", type: "text" },
    { label: "Preview URL", name: "preview_url", type: "text" },
    { label: "Share Percentage", name: "share_percentage", type: "number" },
    { label: "Identification Type", name: "identification_type", type: "text" },
    ...
    { label: "Is Spouse", name: "is_spouse", type: "text" },
