...
import { assessApiService } from '@/components/services/assessmentApi';
        ...
        <div ref={contentRef} className="courier-font  p-8 max-w-3xl mx-auto ">
          ...
          <div className="mb-6">
            <p className="text-sm mb-2">
              <strong>REF:</strong> {report?.pensionerNumber}
            </p>
            <p className="text-sm ">{report?.pensionerName}</p>
            <p className="text-sm ">P.O. Box {retiree?.postal_code?.code}</p>
            <p className="text-sm ">{retiree?.postal_code?.name}</p>
          ...
          <div className="mb-6">
            ...
            <p className="text-sm mt-4">
              In respect of your gratuity/pension arrears has been sent to{' '}
              {retiree?.bankDetails[0].bankBranch?.bank?.name}
              {','} {retiree?.bankDetails[0].bankBranch?.name}
            </p>
            <p className="text-sm mt-4">
