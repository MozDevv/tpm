...

      {
        ...
        subChildren: [
          ...
          },
          {
            ...
            path: '/pensions/finance/payments/pending-payment-vouchers',
          },

          {
            title: 'Approved Payment Vouchers',
            path: '/pensions/finance/payments/approved-payment-vouchers',
          },

          {
            title: 'Scheduled Payment Vouchers',
            path: '/pensions/finance/payments/scheduled-payment-vouchers',
          },
          {
            title: 'Posted Payment Vouchers',
            path: '/pensions/finance/payments/posted-payment-vouchers',
          },
        ],
      },
      {
