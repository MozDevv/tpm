...
const BaseFinanceInputCard = ({
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "documentTypeId") {
      console.log("Document Type ID: ", value);
      const generateDocumentNo = async () => {
        try {
          const res = await apiService.get(endpoints.generateDocumentNo, {
            documentTypeId: value,
          });

          setFormData((prev) => ({
            ...prev,
            documentNo: res.data.data,
          }));
        } catch (error) {
...
export default BaseFinanceInputCard;
